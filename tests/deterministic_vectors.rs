...
const IDENTITY_FERNET_IV: [u8; 16] = [
    0xaa, 0xbb, 0xcc, 0xdd, 0xee, 0xff, 0x10, 0x20, 0x30, 0x40, 0x50, 0x60, 0x70, 0x80, 0x90, 0xa0,
];
...
const RATCHET_EXPECTED_CIPHER_HEX: &str = "5f09b7f97a40b50220697064b43b27411b07a4aa1fe05370b27519826983d30d0a1a2a3a4a5a6a7a8a9aaabacadaeafa1c43424cf0e30e5a9b375d3250dcb32b3e6291333de02a8167b705e13399b49407822ef7e7436198b48d0c66b7b8fb1eba13fefd647b246da4be78a1598a5c79";
...
fn deterministic_ratchet_vector_matches_reference() {
    ...
    let mut destination =
        SingleOutputDestination::new(identity, DestinationName::new("vectors", "out"));
...
fn ratchet_enforcement_vector_matches_reference() {
    ...
    let mut destination =
        SingleInputDestination::new(identity, DestinationName::new("vectors", "in"));
    ...
    assert!(
        decrypt.is_err(),
        "ratchet enforcement must reject identity ciphertext"
    );
}
...
fn build_reference_announce() -> Packet {
    ...
    let mut destination =
        SingleInputDestination::new(identity, DestinationName::new("vectors", "announce"));
